    ...
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <textarea 
            ...
            onBlur={(e) => { if (e.target.value !== lead.notes) onUpdate(String(lead.id), { notes: e.target.value }); }} 
      ...
      <div className="space-y-4">
        <div className="group">
          ...
          <div className="flex gap-2">
            <input 
              ...
              onBlur={(e) => { if (e.target.value !== lead.testLink) onUpdate(String(lead.id), { testLink: e.target.value }); }} 
        ...
        <div className="group">
          ...
          <input 
            ...
            onBlur={(e) => { if (e.target.value !== lead.reportPdfUrl) onUpdate(String(lead.id), { reportPdfUrl: e.target.value }); }} 
