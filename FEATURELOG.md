...
This file tracks the status and description of features in the EduCompass CRM.

| Feature | Status | Description |
| :--- | :--- | :--- |
| **User Authentication** | ✅ Active | Secure Google OAuth login via Auth.js (NextAuth). |
